#line 1 "Source\\ble_lib\\ble_stack_handler.c"
...
#line 14 "Source\\ble_lib\\ble_stack_handler.c"
#line 15 "Source\\ble_lib\\ble_stack_handler.c"
#line 1 ".\\Include\\nordic_common.h"
...
#line 16 "Source\\ble_lib\\ble_stack_handler.c"
#line 17 "Source\\ble_lib\\ble_stack_handler.c"
#line 18 "Source\\ble_lib\\ble_stack_handler.c"
#line 1 ".\\Include\\nrf_assert.h"
...
#line 19 "Source\\ble_lib\\ble_stack_handler.c"
...
void intern_ble_stack_events_execute(void)
{
    for (;;)
    {
        ...
        {
            do { app_error_handler((err_code), 95, (uint8_t*) "Source\\ble_lib\\ble_stack_handler.c"); } while (0);
        }
...
void SWI2_IRQHandler(void)
{
    if (m_evt_schedule_func != 0)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 113, (uint8_t*) "Source\\ble_lib\\ble_stack_handler.c"); } while (0); } } while (0);
    }
    else
    {
        intern_ble_stack_events_execute();
