...
#line 25 "Source\\ble_serv\\ble_startup.c"
...
#line 27 "Source\\ble_serv\\ble_startup.c"
...
#line 33 "Source\\ble_serv\\ble_startup.c"
#line 34 "Source\\ble_serv\\ble_startup.c"
#line 1 ".\\Include\\nrf_delay.h"
...
#line 35 "Source\\ble_serv\\ble_startup.c"
...
#line 37 "Source\\ble_serv\\ble_startup.c"
...
#line 39 "Source\\ble_serv\\ble_startup.c"
...
#line 40 "Source\\ble_serv\\ble_startup.c"
...
#line 41 "Source\\ble_serv\\ble_startup.c"
...
#line 42 "Source\\ble_serv\\ble_startup.c"
...
#line 43 "Source\\ble_serv\\ble_startup.c"
...
static void gap_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 406, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 416, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0); } } while (0);
}
...
static void advertising_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 445, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0); } } while (0);
}
...
static void services_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 491, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0); } } while (0);
}
...
static void on_conn_params_evt(ble_conn_params_evt_t *p_evt)
{
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_evt->evt_type == BLE_CONN_PARAMS_EVT_FAILED); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 523, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0); } } while (0);

    err_code = sd_ble_gap_disconnect(m_conn_handle, 0x3B);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 526, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0); } } while (0);
}
...
{
    do { app_error_handler((nrf_error), 536, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0);
}
...
static void conn_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 559, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0); } } while (0);
}
...
static void advertising_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 580, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0); } } while (0);
...
static void on_ble_evt(ble_evt_t *p_ble_evt)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 681, (uint8_t*) "Source\\ble_serv\\ble_startup.c"); } while (0); } } while (0);
}
