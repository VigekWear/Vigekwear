...
#line 14 "..\\..\\..\\Software\\Source\\ble_lib\\ble_stack_handler.c"
#line 15 "..\\..\\..\\Software\\Source\\ble_lib\\ble_stack_handler.c"
#line 1 "..\\..\\..\\Software\\Include\\nordic_common.h"
...
#line 16 "..\\..\\..\\Software\\Source\\ble_lib\\ble_stack_handler.c"
#line 17 "..\\..\\..\\Software\\Source\\ble_lib\\ble_stack_handler.c"
#line 18 "..\\..\\..\\Software\\Source\\ble_lib\\ble_stack_handler.c"
#line 1 "..\\..\\..\\Software\\Include\\nrf_assert.h"
...
#line 18 "..\\..\\..\\Software\\Include\\nrf_assert.h"

#line 55 "..\\..\\..\\Software\\Include\\nrf_assert.h"
void assert_nrf_callback(uint16_t line_num, const uint8_t *file_name);


#line 19 "..\\..\\..\\Software\\Source\\ble_lib\\ble_stack_handler.c"


static ble_stack_evt_handler_t       m_evt_handler;          
static ble_stack_evt_schedule_func_t m_evt_schedule_func;    
static uint8_t *                     m_evt_buffer;           
static uint16_t                      m_evt_buffer_size;      
...
void intern_ble_stack_events_execute(void)
{
    for (;;)
    {
        ...
        {
            do { app_error_handler((err_code), 95, (uint8_t*) "..\\..\\..\\Software\\Source\\ble_lib\\ble_stack_handler.c"); } while (0);
        }
...
void SWI2_IRQHandler(void)
{
    if (m_evt_schedule_func != 0)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 113, (uint8_t*) "..\\..\\..\\Software\\Source\\ble_lib\\ble_stack_handler.c"); } while (0); } } while (0);
    }
    else
    {
        intern_ble_stack_events_execute();
