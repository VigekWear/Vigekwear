...
#line 14 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"
...
#line 15 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"
#line 16 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"
...
#line 17 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"
#line 1 "..\\..\\..\\Software\\Include\\nrf_soc.h"
...
#line 18 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"
#line 1 "..\\..\\..\\Software\\Include\\nordic_common.h"
...
#line 19 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"
#line 20 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"
#line 1 "..\\..\\..\\Software\\Include\\nrf.h"
...
#line 21 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"
#line 22 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"
...
#line 23 "..\\..\\..\\Software\\Source\\ble_lib\\ble_flash.c"


static volatile _Bool m_radio_active = 0;   
...
static void flash_page_erase(uint32_t * p_page)
{
    ...
    ((NRF_NVMC_Type *) 0x4001E000UL)->ERASEPAGE = (uint32_t)p_page;
    while (((NRF_NVMC_Type *) 0x4001E000UL)->READY == (0UL))
    {
...
uint32_t ble_flash_page_erase(uint8_t page_num)
{
    uint32_t * p_page = (uint32_t *)(((uint16_t)((NRF_FICR_Type *) 0x10000000UL)->CODEPAGESIZE) * page_num);    
...
uint32_t ble_flash_page_write(uint8_t page_num, uint32_t * p_in_array, uint8_t word_count)
{
    ...
    p_page      = (uint32_t *)(((uint16_t)((NRF_FICR_Type *) 0x10000000UL)->CODEPAGESIZE) * page_num);
    p_curr_addr = p_page;
    ...
    flash_header = 0x45DE0000 | (uint32_t)in_data_crc;
...
uint32_t ble_flash_page_read(uint8_t page_num, uint32_t * p_out_array, uint8_t * p_word_count)
{
    ...
    *p_word_count = (uint8_t)(*(p_curr_addr));
    ...
    calc_crc  = ble_flash_crc16_compute((uint8_t *)p_out_array,
                                        ...
                                        0);
    calc_header = 0x45DE0000 | (uint32_t)calc_crc;
...
uint32_t ble_flash_page_addr(uint8_t page_num, uint32_t ** pp_page_addr)
{
    *pp_page_addr = (uint32_t *)(((uint16_t)((NRF_FICR_Type *) 0x10000000UL)->CODEPAGESIZE) * page_num);
    return ((0x0) + 0);
}
