...
#line 14 "..\\..\\..\\Software\\Source\\twi_master\\twi_hw_master.c"
#line 15 "..\\..\\..\\Software\\Source\\twi_master\\twi_hw_master.c"
#line 16 "..\\..\\..\\Software\\Source\\twi_master\\twi_hw_master.c"
...
#line 17 "..\\..\\..\\Software\\Source\\twi_master\\twi_hw_master.c"
#line 1 "..\\..\\..\\Software\\Include\\nrf_delay.h"
...
#line 18 "..\\..\\..\\Software\\Source\\twi_master\\twi_hw_master.c"
#line 1 "..\\..\\..\\Software\\Include\\nrf_gpio.h"
...
#line 19 "..\\..\\..\\Software\\Source\\twi_master\\twi_hw_master.c"
...
#line 20 "..\\..\\..\\Software\\Source\\twi_master\\twi_hw_master.c"
...
static _Bool twi_master_write(uint8_t *data, uint8_t data_length, _Bool issue_stop_condition)
{
    ...
    while (1)
    {
        while(((NRF_TWI_Type *) 0x40004000UL)->EVENTS_TXDSENT == 0 && (--timeout))
        {
...
static _Bool twi_master_read(uint8_t *data, uint8_t data_length, _Bool issue_stop_condition)
{
    ...
    while (1)
    {
        while((((NRF_TWI_Type *) 0x40004000UL)->EVENTS_RXDREADY == 0) && (--timeout))
        {    
...
static _Bool twi_master_clear_bus(void)
{
    ...
    clk_pin_config                                        =              ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[7];    

    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[7] =               ((0x00UL) << (16UL))           | ((0x06UL)     << (8UL))           | ((0x03UL)    << (2UL))            | ((0UL)  << (1UL))           | ((1UL)     << (0UL));    
    ...
    data_pin_config                                      =         ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[8];

    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[8] =         ((0x00UL) << (16UL))       | ((0x06UL)     << (8UL))       | ((0x03UL)    << (2UL))        | ((0UL)  << (1UL))       | ((1UL)     << (0UL));    
    ...
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << 8); } while(0);
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << 7); } while(0);
    nrf_delay_us(4);

    if ((((((NRF_GPIO_Type *) 0x50000000UL)->IN >> 8) & 0x1UL) == 1) && (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> 7) & 0x1UL) == 1))
    {
        bus_clear = 1;
    }
    else
    {
        ...
        for (i=18; i--;)
        {
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (1UL << 7); } while(0);
            nrf_delay_us(4);
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << 7); } while(0);
            nrf_delay_us(4);

            if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> 8) & 0x1UL) == 1)
            {
                bus_clear = 1;
                break;
            }
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[7] = clk_pin_config;
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[8]  = data_pin_config;
...
_Bool twi_master_init(void)
{
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[7] =             ((0x00UL) << (16UL))       | ((0x06UL)     << (8UL))       | ((0x03UL)    << (2UL))        | ((0UL)  << (1UL))       | ((0UL)      << (0UL));   
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[8] =              ((0x00UL) << (16UL))       | ((0x06UL)     << (8UL))       | ((0x03UL)    << (2UL))        | ((0UL)  << (1UL))       | ((0UL)      << (0UL));    
    ...
    ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_RXDREADY = 0;
    ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_TXDSENT  = 0;
    ((NRF_TWI_Type *) 0x40004000UL)->PSELSCL         = 7;
    ((NRF_TWI_Type *) 0x40004000UL)->PSELSDA         = 8;
    ((NRF_TWI_Type *) 0x40004000UL)->FREQUENCY       = (0x06680000UL) << (0UL);
...
char IIC_write(uint8_t device_addr, uint8_t register_addr, uint8_t *register_data, uint8_t write_length)
{
    ...
    else
    {
        ...
        twi_master_transfer(device_addr, send, write_length + 1, ((_Bool)1)); 
        return 1;
    }
}
