...
void RTC1_COUNTER_START()
{
      ...
      NRF_RTC1->PRESCALER   = 4095;   // 12bit:4095  f(RTC) = 32768/(4095 -1) =  8.00. tick = 1/8 S .
      NRF_RTC1->CC[0]       = 8;  // Compare0 after approx COMPARE_COUNTERTIME seconds.

      
      NVIC_DisableIRQ(RTC1_IRQn);
      NRF_RTC1->EVTENCLR = RTC_EVTENSET_COMPARE0_Disabled << RTC_EVTENSET_COMPARE0_Pos;
      NRF_RTC1->INTENCLR = RTC_INTENSET_OVRFLW_Disabled   << RTC_INTENSET_COMPARE0_Pos; 
