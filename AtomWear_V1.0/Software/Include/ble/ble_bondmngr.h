...
/**@brief Function for storing the bonded masters data including bonding info and System Attributes into
 *          flash memory.
 *
...
/**@brief Function for deleting the bonded master database from flash.
 *
...
/**@brief Function for getting the whitelist containing all currently bonded masters.
 *
...
/**@brief Function for getting the master's address corresponding to a given master_handle.
 *
...
/**@brief Function for storing the System Attributes of a newly connected master.
 *
...
/**@brief Function for fetching the identifiers of known masters.
 *
...
/**@brief Function for deleting a single master from the database.
...
/**@brief Function to verify encryption status link with bonded master is encrypted or not.
 * @details     This function provides status of encrption of the link with a bonded master.
 *              Its is recommended that the application can use the
 *              @ref ble_bondmngr_master_ids_get function to verify if the master is in the
 *              database and then call this function.
 *
 * @warning     Currently the master id paramater is unused and is added only for future extension.
 *              As, today only one link is permitted for the peripheral device, status of current
 *              link is provided. In future, with more possibilities in the topology, master_id
 *              will be needed to identify the master.
 *
