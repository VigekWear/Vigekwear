...
/** @file
 *
 * @defgroup ble_sdk_srv_nus  Service
 * @{
 * @ingroup ble_sdk_srv
 * @brief  Service module.
 *
 * @details This module implements the Service with an RX and TX characteristics. Data
 *          received will be passed to the application, while data sent will be transferred as 
 *          notifications. 
 *          During initialization it adds the  Service and its characteristics to 
