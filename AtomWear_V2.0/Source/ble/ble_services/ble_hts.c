                                      ...
                                      uint8_t        * p_encoded_buffer)
{
	...
	//encode the press data
	encoded_temp = get_press();
	len += uint32_encode(encoded_temp, &p_encoded_buffer[len]);
	//encode the altitude data
	encoded_temp = get_altitude();
	len += uint16_encode(encoded_temp, &p_encoded_buffer[len]);
...
// 	xprintf("%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\r\n", p_encoded_buffer[0],p_encoded_buffer[1],p_encoded_buffer[2],p_encoded_buffer[3],
// 	p_encoded_buffer[4],p_encoded_buffer[5],p_encoded_buffer[6],p_encoded_buffer[7],
// 	p_encoded_buffer[8],p_encoded_buffer[9],p_encoded_buffer[10]);
