                                      ...
                                      uint8_t         * p_encoded_buffer)
{
	...
	//len += uint16_encode(p_rsc_measurement->inst_cadence, &p_encoded_buffer[len]);
	...
	//steps field
	step = get_the_step_count();
	len += uint32_encode(step, &p_encoded_buffer[len]);
	
// 	xprintf("%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\r\n", p_encoded_buffer[0],p_encoded_buffer[1],p_encoded_buffer[2],p_encoded_buffer[3],
// 	p_encoded_buffer[4],p_encoded_buffer[5],p_encoded_buffer[6],p_encoded_buffer[7],p_encoded_buffer[8],
// 	p_encoded_buffer[9],p_encoded_buffer[10], p_encoded_buffer[11], p_encoded_buffer[12],p_encoded_buffer[13]);
